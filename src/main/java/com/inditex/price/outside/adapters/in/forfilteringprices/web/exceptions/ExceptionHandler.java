package com.inditex.price.outside.adapters.in.forfilteringprices.web.exceptions;

import com.inditex.price.adapters.in.forfiltering.BadRequestResponseDTO;
import com.inditex.price.adapters.in.forfiltering.InternalServerErrorResponseDTO;
import com.inditex.price.adapters.in.forfiltering.NotFoundResponseDTO;
import com.inditex.price.application.lib.exceptions.NotFoundException;
import com.inditex.price.application.lib.exceptions.ApplicationException;
...
public class ExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleServletRequestBindingException(ServletRequestBindingException ex,
        ...
        responseDTO.setErrors(MAPPER.toErrorDTO(Collections.singletonList(ErrorType.BAD_REQUEST.toError())));
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<Error> errorList = ex.getBindingResult().getFieldErrors().stream().map(
                fieldError -> Error.builder()
                        ...
                        .code(status.toString()).build()).collect(Collectors.toList());
        BadRequestResponseDTO responseDTO = new BadRequestResponseDTO();
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler({RuntimeException.class, IllegalArgumentException.class})
    ...
    public ResponseEntity<Object> handleInvalidRequestException(NotFoundException ex, WebRequest request) {
        printErrors(ex);
        log.error("handleInvalidRequestException: ", ex);
        NotFoundResponseDTO responseDTO = new NotFoundResponseDTO();
        responseDTO.setErrors(MAPPER.toErrorDTO(Collections.singletonList(ErrorType.RESOURCE_NOT_FOUND.toError())));
